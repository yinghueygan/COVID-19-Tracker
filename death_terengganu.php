...
<div class="center">
  <h2 class="chart_title"><img src="img/terengganu.png" height="25px" alt="terengganu"> Terengganu Covid Death Cases</h2>
  <div class="opt_box">
...
<div class="overall">
  ...
  drawChart();
    ...
    async function getData(){
      const labels = [];
      const data = [];
      const url = 'http://localhost/covid19_tracker/data/death/death_terengganu.csv';
