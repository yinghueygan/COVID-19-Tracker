...
<div class="center">
  <h2 class="chart_title"><img src="img/kelantan.png" height="25px" alt="kelantan"> Kelantan Covid Cases</h2>
  <div class="opt_box">
...
<div class="overall">
  ...
  drawChart();
    ...
    async function getData(){
      ...
      const data2 = [];
      const data3 = [];
      const url = 'http://localhost/covid19_tracker/data/cases/cases_kelantan.csv';
