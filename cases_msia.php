...
<div class="center">
  <h2 class="chart_title"><img src="img/malaysia.png" height="25px" alt="msia"> Malaysia Covid Cases</h2>
  <div class="opt_box">
  <?php include('partials/dropbox_cases.php'); ?>

  <!-- display line chart for covid19 status -->
<div class="overall">
  ...
  drawChart();
    ...
    async function getData(){
      ...
      const data2 = [];
      const data3 = [];
      const url = 'http://localhost/covid19_tracker/data/cases/cases_malaysia.csv';
